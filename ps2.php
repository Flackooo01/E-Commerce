...
<body>
    <nav class="navbar">
        ...
        <ul class="link-container">
            ...
            <li class=""><a href="pscontrollerlist.php" class="link">Ps Controller</a></li>
        </ul>
...
<section class="container sproduct my-5 pt-5">
    <div class="row mt-5">
        <div class="col-lg-5 col-md-12 col-12">
            <img class="img-fluid w-100 pb-1" src="image/ps controller/p2/pic1.png" id="MainImg" alt="">

            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="image/ps controller/p2/pic2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="image/ps controller/p2/pic3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="image/ps controller/p2/pic3.png" width="100%" class="small-img" alt="">
                </div>
